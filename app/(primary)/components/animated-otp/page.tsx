...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Animated OTP Input Component for React — Smooth & Accessible UI | Spec UI",
    description:
      "Create stunning OTP input fields with Spec UI's React component. Smooth animations, accessible design, and easy integration using Tailwind CSS & Framer Motion. Perfect for login and verification flows.",
  ...
  twitter: {
    ...
    title:
      "Animated OTP Input Component for React — Smooth & Accessible UI | Spec UI",
    description:
      "Spec UI's Animated OTP Input component enables smooth, accessible, and customizable OTP fields in React apps. Built with TailwindCSS & Framer Motion.",
