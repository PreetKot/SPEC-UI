...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Fraud Detection Card Component for React — Visual Risk Alerts UI | Spec UI",
    description:
      "Design clean and interactive fraud detection cards with Spec UI's React component. Perfect for fintech apps and dashboards. Smooth animations and accessible design using Tailwind CSS & Framer Motion.",
  ...
  twitter: {
    ...
    title:
      "Fraud Detection Card Component for React — Visual Risk Alerts UI | Spec UI",
    description:
      "Spec UI's Fraud Detection Card component helps developers build interactive fraud alerts and risk analysis UI in React apps with TailwindCSS & Framer Motion.",
