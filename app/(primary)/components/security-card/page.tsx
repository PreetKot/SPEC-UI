...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Security Card Component for React — Visual Security Status & Alerts UI | Spec UI",
    description:
      "Design interactive security status cards with Spec UI's React component. Smooth animations, accessible design, and easy integration using Tailwind CSS & Framer Motion.",
  ...
  twitter: {
    ...
    title:
      "Security Card Component for React — Visual Security Status & Alerts UI | Spec UI",
    description:
      "Spec UI's Security Card component enables developers to build smooth, customizable security status visuals in React apps using TailwindCSS & Framer Motion.",
