...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Social Card Component for React — Profile & Content Preview UI | Spec UI",
    description:
      "Design beautiful social profile and content preview cards with Spec UI's React component. Smooth animations, accessible design, and Tailwind CSS & Framer Motion integration.",
  ...
  twitter: {
    ...
    title:
      "Social Card Component for React — Profile & Content Preview UI | Spec UI",
    description:
      "Spec UI's Social Card component enables developers to build smooth, customizable profile and sharing cards in React apps using TailwindCSS & Framer Motion.",
