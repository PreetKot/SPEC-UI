...
export const democode = `import TextReveal from '@/components/specui/text-reveal';

const text = \`Spec UI is a beautifully designed component library built with Tailwind CSS and Motion.\nIt helps developers build modern, animated UIs faster, with consistent styling and production-ready components.
\`;
