...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Text Rendering Effect Component for React — Animated & Interactive Text UI | Spec UI",
    description:
      "Design interactive text animations like typewriter and gradient reveals with Spec UI's React component. Smooth, accessible, and customizable using Tailwind CSS & Framer Motion.",
  ...
  twitter: {
    ...
    title:
      "Text Rendering Effect Component for React — Animated & Interactive Text UI | Spec UI",
    description:
      "Spec UI's Text Rendering Effect component helps developers build beautiful animated text elements in React apps using TailwindCSS & Framer Motion.",
