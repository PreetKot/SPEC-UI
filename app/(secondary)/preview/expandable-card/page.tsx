...
export const metadata: Metadata = {
  title: "Expandable Card Live Preview | Spec UI",
  description:
    "Interact with Spec UI's Expandable Card component in this live preview. Built with React, Tailwind CSS, and Framer Motion, this component allows for interactive content expansion, making it perfect for job listings, product features, and dynamic UI displays. Fully responsive and copy-paste ready.",
  keywords: [
    "Expandable Card Preview",
    "Interactive Card Component",
    "React Expandable UI",
    "Spec UI Expandable Card",
  ...
  openGraph: {
    title: "Expandable Card Live Preview | Spec UI",
    description:
      "See Spec UI's Expandable Card component in action with this live interactive preview. Built with React, Tailwind CSS & Framer Motion for smooth expandable interactions.",
  ...
  twitter: {
    ...
    title: "Expandable Card Live Preview | Spec UI",
    description:
      "Live demo of Spec UI's Expandable Card component with interactive content reveal animations, built using React, Tailwind CSS, and Framer Motion.",
