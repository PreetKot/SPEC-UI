        ...
        <div className="mx-auto flex max-w-full flex-col items-start justify-between pl-4 pr-8 text-sm text-zinc-500 dark:text-zinc-400 sm:flex-row">
          <div>
            ...
            <div className="mr-2 mt-2 max-w-fit">
              <Link
                href="https://x.com/compose/tweet?text=🚀%20Just%20discovered%20%23SpecUI%20and%20it%27s%20a%20game-changer%20for%20building%20modern%20UIs!%20%F0%9F%9A%80%20%23WebDev%20%23React"
                target="_blank"
              >
            ...
            <p className="mt-5 text-sm text-zinc-500 dark:text-zinc-400">
              © {new Date().getFullYear()} Spec UI. All rights reserved.
            </p>
          </div>
